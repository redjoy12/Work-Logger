...
### Fixed
- Fixed window layout when maximized to properly center and expand UI elements across full window width
- Fixed pylint broad-exception-caught warning in _install_git_update method
